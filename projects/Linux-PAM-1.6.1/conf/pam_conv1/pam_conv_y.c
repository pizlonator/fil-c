...
{
       0,    59,    59,    60,    61,    62,    68,   135,   141,   144,
     159,   169
};
#endif
...
#line 68 "pam_conv_y.y"
	...
	(yyvsp[-5].string)[i] = tolower((unsigned char)(yyvsp[-5].string)[i]);
    }

    /* $1 = service-name */
    yyerror("Appending to " PAM_D "/%s", (yyvsp[-5].string));

    if (asprintf(&filename, PAM_D_FILE_FMT, (yyvsp[-5].string)) < 0) {
...
#line 1242 "pam_conv_y.c"
    break;

  case 7: /* line: error NL  */
#line 135 "pam_conv_y.y"
           {
    yyerror("malformed line");
}
#line 1250 "pam_conv_y.c"
    break;
...
#line 1258 "pam_conv_y.c"
    break;

  case 9: /* tokenls: tokenls tok  */
#line 144 "pam_conv_y.y"
              {
    if ((yyvsp[-1].string)) {
	if (asprintf(&(yyval.string), "%s %s", (yyvsp[-1].string), (yyvsp[0].string)) < 0) {
...
#line 1300 "pam_conv_y.c"
    break;


#line 1304 "pam_conv_y.c"
